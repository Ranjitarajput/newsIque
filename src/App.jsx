        ...
        <Router>
          ...
          />
            ...
            <Routes>
              ...
              <Route path="/newsIque" exact element={<News  setProgress={this.setProgress} apiKey={this.apiKey} key="general" pageSize={this.pageSize} category="general" searchQuery={this.state.searchQuery}/>}> </Route>
